...
class Visualizer:    
    ...
    @staticmethod
    def plot_feature_importance(feature_importance_dict, top_n=15, save_path=r'D:\UIT\DS200\DS2000 Project\Results\Visualization\feature_importance.png'):
...
class Trainer:    
    ...
    def train(self, train_loader, val_loader, X_train, X_val, y_train_reg, y_val_reg, y_train_cls, y_val_cls, 
              feature_names, epochs=15, lr=2e-5, save_path=r'D:\UIT\DS200\DS2000 Project\Results\Best_Model\tiktok_model.pth'):
    ...
    def evaluate_and_visualize(self, val_loader, y_val_reg, y_val_cls, baseline_results, 
                              model_path=r'D:\UIT\DS200\DS2000 Project\Results\Best_Model\tiktok_model.pth'):        
        # Load best model
        ...
        best_reg_idx, best_cls_idx = visualizer.plot_model_performance_comparison(
            neural_results, baseline_results, r'D:\UIT\DS200\DS2000 Project\Results\Best_Model\model_performance_economic.png'
        )
        
        visualizer.plot_feature_importance(
            self.baseline_models.feature_importance, 
            top_n=15, 
            save_path=r'D:\UIT\DS200\DS2000 Project\Results\Best_Model\feature_importance_business.png'
        )
        
        return neural_results, regression_predictions, classification_predictions
    
    def predict(self, training_data, user_trend_features, text_features, model_path=r'D:\UIT\DS200\DS2000 Project\Results\Best_Model\tiktok_model.pth'):
        checkpoint = torch.load(model_path, map_location=self.device)
        self.model = TikTokGrowthPredictor(text_dim=checkpoint['model_config']['text_dim'])
        self.model.load_state_dict(checkpoint['model_state_dict'])
        self.model.to(self.device)
...
if __name__ == "__main__":
    ...
    csv_file_path = r"D:\UIT\DS200\DS2000 Project\Dataset\Preprocessed Data\training_data.csv"  # Preprocessed CSV
    ...
    # Save results
    results_df.to_csv(r'D:\UIT\DS200\DS2000 Project\Results\Prediction\tiktok_predictions.csv', index=False)