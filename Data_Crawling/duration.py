...
async def fill_missing_durations():
    df = pd.read_csv(r"D:\UIT\DS200.P21_Big_Data-4\Dataset\Raw Data\Merged Data\streaming_data.csv")
    ...
    df.to_csv(r"D:\UIT\DS200.P21_Big_Data-4\Dataset\Preprocessed_Data\streaming_data.csv", index=False, encoding="utf-8-sig")
