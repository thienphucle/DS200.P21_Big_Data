...
headers = {
    ...
    'x-guest-token': 'WYvcUz3owF90iZ4AJQHNaKDnyqOmTret',
...
params = {
    ...
    'aggregations': '2',
    'trackity_id': '975c8456-2721-fadb-b95d-666aa449e5e0',
    'category': '1795',  # Ví dụ: '1789' là danh mục cho điện thoại, máy tính bảng trên Tiki
    'page': '1',
    # 'src': 'c1795',  # Cập nhật theo danh mục mới
