...
def main():
    csv_file_path = "Dataset/PreprocessedData/training_data.csv"  # Update CSV path
    ...
    if not features['training_data'].empty:
        ...
        # Save results
        output_files = {
            'training_data': 'Dataset/FEResults/training_features.csv',
            'user_trend_features': 'Dataset/FEResults/user_trends.csv',
            'video_features': 'Dataset/FEResults/video_features.csv'
        }
        ...
        import pickle
        np.save('tiktok_text_features.npy', features['text_features'])
        with open('tiktok_text_vectorizer.pkl', 'wb') as f:
